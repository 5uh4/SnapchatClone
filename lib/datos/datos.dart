import 'package:snapchat_v2/model/articulos.dart';

class Datos {
  static List<Articulos> subs = [
    Articulos('Elon Musk\'s take on Twitter'),
    Articulos('Jay-Z on blast for being too rich'),
  ...
  static List<Articulos> trendingTopics = [
    Articulos('Robert Downey Jr. might come back to Marvel'),
    Articulos('Everything Everywhere all at Once: Movie of the year?'),
  ...
  static List<Articulos> popular = [
    Articulos('Fashion trends for this spring season'),
    Articulos('How much longer must we wait for the Socialist revolution?'),
